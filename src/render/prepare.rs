...
use crate::{backup, catalog, engine_version, paths, project_config, version, yaml_subset};
...
mod tests {
    ...
    use crate::render::test_support::{file, project, text_of};
    use crate::render::{BackupBounds, Env, Stop, render};
